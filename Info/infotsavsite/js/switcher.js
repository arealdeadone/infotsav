		...
		return this.each(function(){
			var th=$(this)
				,_=th.data('tabs')||{
					...
					actFu:function(){
						_.prev
							&& _.prev.stop().animate({left:1700},800, 'easeInBack', function(){_.li.not(_.curr).css({display: 'none'})});
							
						_.curr
							&& _.curr.stop().css({display:'block', left:-1500}).stop().delay(500).animate({left:0},800, 'easeOutBack', function(){	});
