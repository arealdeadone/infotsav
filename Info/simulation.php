...
<title>Simulation Events </title>
 ...
 <script>
  ...
  //upper box title and links  
    ...
    var tmp = ttl+"</b></h2>";
    out = out + tmp;
    if(a==12) document.getElementById("myLargeModalLabel12").innerHTML = out;/*takshil_change*/
    if(a==13) document.getElementById("myLargeModalLabel13").innerHTML = out;
    if(a==14) document.getElementById("myLargeModalLabel14").innerHTML = out;
    if(a==15) document.getElementById("myLargeModalLabel15").innerHTML = out;
   		...
   		<?php
            $xml = file_get_contents('events.xml');
             ...
             //echo $EVENTLIST->EVENT[1]->TITLE;?>		
   				...
   				<h3 class="animated bounceInRight">Simulation Events</h3>
...
guns has crossed the rallying point and got launched, with all doors open for the entries to come in and take their position in the various heats.With the event getting started on ***. ’15 shall proceed on up till ******. ’15. So, it’s time to gear up with what all you have in your bag, to be a part of the most crowd-pulling event of Central India. It brings you an opportunity to interact with such personalities who are at the helm of changing our world today. Previous speakers who have graced the lecture series include the likes of John C. Mather (The 2006 Physics Nobel Laureate), Lyn Evans (Project Leader, Large Hadron Collider, CERN), Pranav Mistry (The Inventor of 6th Sense Technology), Stephen P. Morse (Chief Architect, Intel 8086 Microprocessor), Richard Stallman (Founder, Free Software Movement), Walter Bender (Ex-Director, MIT Media Labs), etc. Having gained immense popularity over the past few years, it is widely recognized as the biggest and the best lecture series in the entire nation and we are sure that we'll be successful in outdoing ourselves yet again. So come, listen and get inspired!</p> -->
 ...
 <!--start of first event  JOB Bsadf-->   
<div class="content-section-b">
            ...
            $xml = file_get_contents('events.xml');
             $EVENTLIST = new SimpleXMLElement($xml);
             echo $EVENTLIST->EVENT[12]->TITLE;?></h2>
            		       <p  class="animated bounceInLeft"><?php  echo $EVENTLIST->EVENT[12]->DESCRIPTION; ?></p>
						    <a class="Read-more" onclick="myFunction(12)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg">Read more</a>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="z-index:9999;">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
	<div id='myLargeModalLabel12' class="modal-header"  ></div>
 ...
 <div class="container"><ul class="nav navbar-nav pull-center" >
			...
			<li data-target="#carousel-example-generic" data-slide-to="2"><a style="color:#1abc9c;" href="" title="Home">TIMELINE</a></li>
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
	...
	<?php  echo $EVENTLIST->EVENT[12]->DESCRIPTION; ?>
	 </div>
    </div>
    ...
    <div class="item" style="overflow:scroll; height:300px; ">
	  ...
	  <?php  echo $EVENTLIST->EVENT[12]->RULES; ?>
	 </div>
    </div>
     <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container"><br>
	 
	 <?php  echo $EVENTLIST->EVENT[12]->TIMELINE; ?>
	 </div>
    </div>
    <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container" ><br>
	 
	<?php  echo $EVENTLIST->EVENT[12]->CONTACTS; ?>
	 </div>
    </div>
  </div>
  ...
  <div class="col-md-6" style="margin-left:auto; margin-right:auto;">
							<div class="clearfix"></div>
								<img class="img-responsive  eventspic animated bounceInRight"  src="img/job bureau.jpg" alt="">
...
<div class="content-section-a">
 		        ...
 		        <div class="container">
					<div class="row">
						<div class="col-md-6 " style="margin-left:auto; margin-right:auto;">
							<div class="clearfix"></div>
								<img class="img-responsive  eventspic "  src="img/forex.jpg" alt="">
                 ...
                 <div class="col-md-6  ">
                       <div class="clearfix"></div>
                            <h2  class="animated bounceInRight" ><?php echo $EVENTLIST->EVENT[13]->TITLE; ?></h2>
 		                   <p  class="animated bounceInRight"> <?php echo $EVENTLIST->EVENT[13]->DESCRIPTION; ?>
                           </p>                                                                                                                    <!--takshil_change-->
			<!--takshil_change-->   <a class="Read-more" onclick="myFunction(13)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg1">Read more</a>
    <div class="modal fade bs-example-modal-lg1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content"  >
	<div id='myLargeModalLabel13' class="modal-header"  ></div>
...
<div class="container"> <ul class="nav navbar-nav pull-center" >
			...
			<li data-target="#carousel-example-generic1" data-slide-to="0" class="active"><a style="color:#1abc9c;" href="" title="Home">DESCRIPTION</a></li>
			
            <li  data-target="#carousel-example-generic1" data-slide-to="1"><a style="color:#1abc9c" href="" title="About">RULES</a></li>
			
			<li data-target="#carousel-example-generic1" data-slide-to="2"><a style="color:#1abc9c;" href="" title="Home">TIMELINE</a></li>
			
            <li  data-target="#carousel-example-generic1" data-slide-to="3"><a style="color:#1abc9c" href="" title="About">CONTACTS</a></li>
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
    <div class="item active" style="overflow:scroll; height:300px; ">
     ...
     <div class="container"><br>
	<?php  echo $EVENTLIST->EVENT[13]->DESCRIPTION; ?>
	 </div>
    </div>
    ...
    <div class="item" style="overflow:scroll; height:300px; ">
	  ...
	  <?php  echo $EVENTLIST->EVENT[13]->RULES; ?>
	 </div>
    </div>
     <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container"><br>
	 
	 <?php  echo $EVENTLIST->EVENT[13]->TIMELINE; ?>
	 </div>
    </div>
    <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container" ><br>
	 
	<?php  echo $EVENTLIST->EVENT[13]->CONTACTS; ?>
	 </div>
    </div>
  </div>
            <!-- Controls                           
...
<div class="content-section-b">
            ...
            $xml = file_get_contents('events.xml');
             $EVENTLIST = new SimpleXMLElement($xml);
             echo $EVENTLIST->EVENT[14]->TITLE;?></h2>
            		       <p  class="animated bounceInLeft"><?php  echo $EVENTLIST->EVENT[14]->DESCRIPTION; ?></p>
						    <a class="Read-more" onclick="myFunction(14)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg14">Read more</a>
...
<div class="modal fade bs-example-modal-lg14" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
	<div id='myLargeModalLabel14' class="modal-header"  ></div>
 ...
 <div class="container"> <ul class="nav navbar-nav pull-center" >
            ...
            <li  data-target="#carousel-example-generic2" data-slide-to="1"><a style="color:#1abc9c" href="" title="About">RULES</a></li>
			
			<li data-target="#carousel-example-generic2" data-slide-to="2"><a style="color:#1abc9c;" href="" title="Home">TIMELINE</a></li>
		
            <li  data-target="#carousel-example-generic2" data-slide-to="3"><a style="color:#1abc9c" href="" title="About">CONTACTS</a></li>
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
    <div class="item active" style="overflow:scroll; height:300px; ">
     ...
     <div class="container"><br>
	<?php  echo $EVENTLIST->EVENT[14]->DESCRIPTION; ?>
	 </div>
    </div>
    ...
    <div class="item" style="overflow:scroll; height:300px; ">
	  ...
	  <?php  echo $EVENTLIST->EVENT[14]->RULES; ?>
	 </div>
    </div>
     <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container"><br>
	 
	 <?php  echo $EVENTLIST->EVENT[14]->TIMELINE; ?>
	 </div>
    </div>
    <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container" ><br>
	 
	<?php  echo $EVENTLIST->EVENT[14]->CONTACTS; ?>
	 </div>
    </div>
  </div>
  ...
  <a class="right carousel-control" href="#carousel-example-generic2" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right"></span>
	  ...
	  <div class="col-md-6" style="margin-left:auto; margin-right:auto;">
							<div class="clearfix"></div>
								<img class="img-responsive  eventspic"  src="img/stock.png" alt="">
...
<div class="content-section-a">
 		        ...
 		        <div class="container">
				    ...
				    <div class="col-lg-5"  >
                       <div class="clearfix"></div>
                           <img class="img-responsive  eventspic"  src="img/trove trace.png" alt="">
                 ...
                 <div class="col-lg-5  ">
                       <div class="clearfix"></div>
                            <h2  class="animated bounceInRight" ><?php echo $EVENTLIST->EVENT[15]->TITLE; ?></h2>
 		                   <p  class="animated bounceInRight"> <?php echo $EVENTLIST->EVENT[15]->DESCRIPTION; ?>
                           </p>                                                                                                                    <!--takshil_change-->
			<!--takshil_change-->   <a class="Read-more" onclick="myFunction(15)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg15">Read more</a>
    <div class="modal fade bs-example-modal-lg15" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
	<div id='myLargeModalLabel15' class="modal-header"  ></div>
...
<div class="container"> <ul class="nav navbar-nav pull-center" >
			...
			<li data-target="#carousel-example-generic3" data-slide-to="0" class="active"><a style="color:#1abc9c;" href="" title="Home">DESCRIPTION</a></li>
			
            <li  data-target="#carousel-example-generic3" data-slide-to="1"><a style="color:#1abc9c" href="" title="About">RULES</a></li>
			
			<li data-target="#carousel-example-generic3" data-slide-to="2"><a style="color:#1abc9c;" href="" title="Home">TIMELINE</a></li>
			
            <li  data-target="#carousel-example-generic3" data-slide-to="3"><a style="color:#1abc9c" href="" title="About">CONTACTS</a></li>
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
    <div class="item active" style="overflow:scroll; height:300px; ">
     ...
     <div class="container"><br>
	<?php  echo $EVENTLIST->EVENT[15]->DESCRIPTION; ?>
	 </div>
    </div>
    ...
    <div class="item" style="overflow:scroll; height:300px; ">
	  ...
	  <?php  echo $EVENTLIST->EVENT[15]->RULES; ?>
	 </div>
    </div>
     <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container"><br>
	 
	 <?php  echo $EVENTLIST->EVENT[15]->TIMELINE; ?>
	 </div>
    </div>
    <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container" ><br>
	 
	<?php  echo $EVENTLIST->EVENT[15]->CONTACTS; ?>
	 </div>
    </div>
  </div>              
