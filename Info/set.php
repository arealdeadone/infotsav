      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-2">
          <ul class="nav navbar-nav navbar-right">
           ...
           <li><a style="color:#1abc9c"href="" data-toggle="modal" data-target="#appmodal" title="Mobile app">Mobile App</a></li>
...
+91- 8989735126
	...
	<!-- Settings---->
			...
			<div class="col-md-12">
			 <div class="row">
                <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="img/profilepic.jpg" class="img-circle img-responsive" style="width:180px; height:180px;"> </div>
...
<footer style="margin-top:260px; bottom:0px">
		<div class="container">
			<div class="row">
