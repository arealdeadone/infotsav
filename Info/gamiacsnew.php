...
<html>
	<head>
		<title>Gamiacs Events |Infotsav 2k16</title>
		<meta charset="utf-8" />
...
$(document).ready(function(){
	...
	<body class="landing">
		...
		<!-- Banner -->
			<section id="banner" style="background-image: url(img/game.jpg);" >
				<h2 style="font-family: farray;">GAMIACS</h2>
...
<<<<<<< HEAD
						<span class="image"><img  src="img/<?php echo $EVENTLIST->EVENT[$i]->IMAGE; ?>" alt="" /></span>
=======
						<span class="image"><img  src="img/
						<?php echo $EVENTLIST->EVENT[$i]->IMAGE; ?>"  alt="" /></span>
>>>>>>> master
						<div class="content" >
