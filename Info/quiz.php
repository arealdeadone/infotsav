 ...
 <script>
  ...
  //upper box title and links  
    ...
    out = out + tmp;
     ...
     if(a==16) document.getElementById("myLargeModalLabel16").innerHTML = out;/*takshil_change*/
     if(a==17) document.getElementById("myLargeModalLabel17").innerHTML = out;
   		...
   		<?php
            $xml = file_get_contents('events.xml');
             ...
             //echo $EVENTLIST->EVENT[1]->TITLE;?>		
   				...
   				<h3 class="animated bounceInRight">Quiz</h3>
...
<div class="content-section-b">
            ...
            $xml = file_get_contents('events.xml');
             $EVENTLIST = new SimpleXMLElement($xml);
             echo $EVENTLIST->EVENT[16]->TITLE;?></h2>
            		       <p  class="animated bounceInLeft"><?php  echo $EVENTLIST->EVENT[16]->DESCRIPTION; ?></p>
						    <a class="Read-more" onclick="myFunction(16)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg">Read more</a>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="z-index:9999;">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
	<div id='myLargeModalLabel16' class="modal-header"  ></div>
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
	...
	<?php  echo $EVENTLIST->EVENT[16]->DESCRIPTION; ?>
	 </div>
    </div>
    ...
    <div class="item" style="overflow:scroll; height:300px; ">
	  ...
	  <?php  echo $EVENTLIST->EVENT[16]->RULES; ?>
	 </div>
    </div>
     <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container"><br>
	 
	 <?php  echo $EVENTLIST->EVENT[16]->TIMELINE; ?>
	 </div>
    </div>
    <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container" ><br>
	 
	<?php  echo $EVENTLIST->EVENT[16]->CONTACTS; ?>
	 </div>
    </div>
  </div>
...
<div class="content-section-a">
            ...
            $xml = file_get_contents('events.xml');
             $EVENTLIST = new SimpleXMLElement($xml);
             echo $EVENTLIST->EVENT[17]->TITLE;?></h2>
 		                   <p  class="animated bounceInRight"> <?php echo $EVENTLIST->EVENT[17]->DESCRIPTION; ?>
                           </p>                                                                                                                    <!--takshil_change-->
			<!--takshil_change-->   <a class="Read-more" onclick="myFunction(17)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg17">Read more</a>
    <div class="modal fade bs-example-modal-lg17" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
	<div id='myLargeModalLabel17' class="modal-header"  ></div>
...
<div class="container"> <ul class="nav navbar-nav pull-center" >
			...
			<li data-target="#carousel-example-generic3" data-slide-to="0" class="active"><a style="color:#1abc9c;" href="">DESCRIPTION</a></li>
			
            <li  data-target="#carousel-example-generic3" data-slide-to="1"><a style="color:#1abc9c" href="" >RULES</a></li>
			
			<li data-target="#carousel-example-generic3" data-slide-to="2"><a style="color:#1abc9c;" href="">TIMELINE</a></li>
			
            <li  data-target="#carousel-example-generic3" data-slide-to="3"><a style="color:#1abc9c" href="" >CONTACTS</a></li>
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
    <div class="item active" style="overflow:scroll; height:300px; ">
     ...
     <div class="container"><br>
	<?php  echo $EVENTLIST->EVENT[17]->DESCRIPTION; ?>
	 </div>
    </div>
    ...
    <div class="item" style="overflow:scroll; height:300px; ">
	  ...
	  <?php  echo $EVENTLIST->EVENT[17]->RULES; ?>
	 </div>
    </div>
     <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container"><br>
	 
	 <?php  echo $EVENTLIST->EVENT[17]->TIMELINE; ?>
	 </div>
    </div>
    <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container" ><br>
	 
	<?php  echo $EVENTLIST->EVENT[17]->CONTACTS; ?>
	 </div>
    </div>
  </div>              
