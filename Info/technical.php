   		...
   		<?php
            $xml = file_get_contents('events.xml');
             ...
             //echo $EVENTLIST->EVENT[1]->TITLE;?>		
   				...
   				<h3 class="animated bounceInRight">Technical Events</h3>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="z-index:9999;">
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
  ...
  <div class="col-md-6" style="margin-left:auto; margin-right:auto;">
							<div class="clearfix"></div>
								<img class="img-responsive  eventspic animated bounceInRight"  src="img/wwwizard.png" alt="">
...
<div class="content-section-a">
 		        ...
 		        <div class="container">
				    ...
				    <div class="col-lg-5"  >
                       <div class="clearfix"></div>
                           <img class="img-responsive eventspic"  src="img/app studio.jpg" alt="">
            ...
            $xml = file_get_contents('events.xml');
             $EVENTLIST = new SimpleXMLElement($xml);
             echo $EVENTLIST->EVENT[1]->TITLE;?></h2>
...
<div class="content-section-b">
            ...
            $xml = file_get_contents('events.xml');
             $EVENTLIST = new SimpleXMLElement($xml);
             echo $EVENTLIST->EVENT[6]->TITLE;?></h2>
            		       <p  class="animated bounceInLeft"><?php  echo $EVENTLIST->EVENT[6]->DESCRIPTION; ?></p>
						    <a class="Read-more" onclick="myFunction(6)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg6">Read more</a>
...
<div class="modal fade bs-example-modal-lg6" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel6" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" >
	<div id='myLargeModalLabel6' class="modal-header"  ></div>
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
    <div class="item active" style="overflow:scroll; height:300px; ">
     ...
     <div class="container"><br>
	<?php  echo $EVENTLIST->EVENT[6]->DESCRIPTION; ?>
	 </div>
    </div>
    ...
    <div class="item" style="overflow:scroll; height:300px; ">
	  ...
	  <?php  echo $EVENTLIST->EVENT[6]->RULES; ?>
	 </div>
    </div>
     <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container"><br>
	 
	 <?php  echo $EVENTLIST->EVENT[6]->TIMELINE; ?>
	 </div>
    </div>
    <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container" ><br>
	 
	<?php  echo $EVENTLIST->EVENT[6]->CONTACTS; ?>
	 </div>
    </div>
  </div>
  ...
  <a class="right carousel-control" href="#carousel-example-generic2" role="button" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right"></span>
	  ...
	  <div class="col-md-6" style="margin-left:auto; margin-right:auto;">
							<div class="clearfix"></div>
								<img class="img-responsive  eventspic"  src="img/jobs.jpg" alt="">
...
<div class="content-section-a">  <!-- Escape event -->
 		        ...
 		        <div class="container">
				    ...
				    <div class="col-lg-6"  >
                       <div class="clearfix"></div>
                           <img class="img-responsive eventspic"  src="img/escape.jpg" alt="">
                 ...
                 <div class="col-lg-6  ">
                       <div class="clearfix"></div>
 		                   ...
 		                   <p  class="animated bounceInRight"> <br> <?php echo $EVENTLIST->EVENT[3]->DESCRIPTION; ?> <br>

				 									
                           </p>                                                                                                                    <!--takshil_change-->
			<!--takshil_change-->   <a class="Read-more" onclick="myFunction(3)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg3">Read more</a>  <a class="Read-more" href="https://docs.google.com/forms/d/1E_fT8IJiOw1nhAYVwarx3iFowvQX2r0XqQRIehjCLa0/viewform?edit_requested=true" target="_blank" role="button" style="margin-left:10px">Escape Form</a>
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
    <div class="item active" style="overflow:scroll; height:300px; ">
     ...
     <div class="container"><br>
<a style="color:#1abc9c; font-size:18px" href="https://docs.google.com/forms/d/1E_fT8IJiOw1nhAYVwarx3iFowvQX2r0XqQRIehjCLa0/viewform?edit_requested=true" target="_blank">Escape form</a> <br> <br>
...
<div class="modal fade bs-example-modal-lg4" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
	...
	<?php  echo $EVENTLIST->EVENT[4]->CONTACTS; ?>
	  ...
	  <div class="col-lg-5"  >
                       <div class="clearfix"></div>
                           <img class="img-responsive eventspic"  src="img/bug the spot.jpg" alt="">
...
<div class="content-section-a">
 		        ...
 		        <div class="container">
				    ...
				    <div class="col-lg-6"  >
                       <div class="clearfix"></div>
                           <img class="img-responsive eventspic"  src="img/it quiz.jpg" alt="">
 ...
 <ul class="nav navbar-nav pull-center" >
			...
			<li data-target="#carousel-example-generic6" data-slide-to="0" class="active"><a style="color:#1abc9c;" href="" title="Home">DESCRIPTION</a></li>
			
            <li  data-target="#carousel-example-generic6" data-slide-to="1"><a style="color:#1abc9c" href="" title="About">RULES</a></li>
			
			<li data-target="#carousel-example-generic6" data-slide-to="2"><a style="color:#1abc9c;" href="" title="Home">TIMELINE</a></li>
			
            <li  data-target="#carousel-example-generic6" data-slide-to="3"><a style="color:#1abc9c" href="" title="About">CONTACTS</a></li>
...
<div class="content-section-b">
            ...
            $xml = file_get_contents('events.xml');
             $EVENTLIST = new SimpleXMLElement($xml);
             echo $EVENTLIST->EVENT[23]->TITLE;?></h2>
            		       <p  class="animated bounceInLeft"><?php  echo $EVENTLIST->EVENT[23]->DESCRIPTION; ?></p>
						    <a class="Read-more" onclick="myFunction(23)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg23">Read more</a>
...
<div class="modal fade bs-example-modal-lg23" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
	<div id='myLargeModalLabel23' class="modal-header"  ></div>
      <div id="carousel-example-generic23" class="carousel slide" data-ride="carousel">
 ...
 <div class="container"><ul class="nav navbar-nav pull-center" >
			...
			<li data-target="#carousel-example-generic23" data-slide-to="0" class="active"><a style="color:#1abc9c;" href="" title="Home">DESCRIPTION</a></li>
			
            <li  data-target="#carousel-example-generic23" data-slide-to="1"><a style="color:#1abc9c" href="" title="About">RULES</a></li>
			
			<li data-target="#carousel-example-generic23" data-slide-to="2"><a style="color:#1abc9c;" href="" title="Home">TIMELINE</a></li>
			
            <li  data-target="#carousel-example-generic23" data-slide-to="3"><a style="color:#1abc9c" href="" title="About">CONTACTS</a></li>
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
    <div class="item active" style="overflow:scroll; height:300px; ">
     ...
     <div class="container"><br>
	<?php  echo $EVENTLIST->EVENT[23]->DESCRIPTION; ?>
	 </div>
    </div>
    ...
    <div class="item" style="overflow:scroll; height:300px; ">
	  ...
	  <?php  echo $EVENTLIST->EVENT[23]->RULES; ?>
	 </div>
    </div>
     <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container"><br>
	 
	 <?php  echo $EVENTLIST->EVENT[23]->TIMELINE; ?>
	 </div>
    </div>
    <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container" ><br>
	 
	<?php  echo $EVENTLIST->EVENT[23]->CONTACTS; ?>
	 </div>
    </div>
  </div>  
	  ...
	  <div class="col-lg-5"  >
                       <div class="clearfix"></div>
                           <img class="img-responsive eventspic"  src="img/codeweavers.jpg" alt="">
