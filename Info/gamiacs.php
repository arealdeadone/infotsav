...
<link rel="shortcut icon" href="img/logo200.png" >
 ...
 <script>
  ...
  //upper box title and links  
    ...
    var tmp = ttl+"</b></h2>";
    out = out + tmp;
    if(a==18) document.getElementById("myLargeModalLabel18").innerHTML = out;/*takshil_change*/
			...
			<br><br><br><br>
				<div class="container">
					<div class="row">
						...
						<h3 style="color:#1bba9c; font-weight: 600;">Gamiacs</h3>
						
						<p style="border-top-style: solid;border-width: 2px; border-color: #1bba9c;
  padding-top:1em;
  text-align:justify;">Gamiacs is an organised multiplayer gaming tournament which allows participants to compete against one another. The games associated with the tournament are Counter Strike, FIFA, Mortal Kombat and Injustice. This tournament encourages gamers to come forward and test their gaming skills against other gamers!</p>
     	        
						<a class="Read-more" onclick="myFunction(18)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg18" >Read more</a>
						
						</div>
						<div class="col-lg-5"  >
                       <div class="clearfix"></div>
                           <img class="img-responsive eventspic"  src="img/abc/gamiacs.png" alt="">
...
<!--<div class="content-section-b">
            ...
            $xml = file_get_contents('events.xml');
             ...
             echo $EVENTLIST->EVENT[18]->TITLE;?></h2>
            		       <p  class="animated bounceInLeft"><?php  echo $EVENTLIST->EVENT[18]->DESCRIPTION; ?></p>
						    <a class="Read-more" onclick="myFunction(18)" role="button" data-toggle="modal" data-target=".bs-example-modal-lg18">Read more</a>
...
<div class="modal fade bs-example-modal-lg18  tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="z-index:9999;">
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
	<div id='myLargeModalLabel18' class="modal-header"  ></div>
      <div id="carousel-example-generic18" class="carousel slide" data-ride="carousel">
 ...
 <ul class="nav navbar-nav pull-center" >
			...
			<li data-target="#carousel-example-generic18" data-slide-to="0" class="active"><a style="color:#1abc9c;" href="" title="Home">DESCRIPTION</a></li>
			
            <li  data-target="#carousel-example-generic18" data-slide-to="1"><a style="color:#1abc9c" href="" title="About">RULES</a></li>
			
			<li data-target="#carousel-example-generic18" data-slide-to="2"><a style="color:#1abc9c;" href="" title="Home">TIMELINE</a></li>
			
            <li  data-target="#carousel-example-generic18" data-slide-to="3"><a style="color:#1abc9c" href="" title="About">CONTACTS</a></li>
 ...
 <div class="carousel-inner" style="border-top: 1px solid #ddd;">
	...
	<?php  echo $EVENTLIST->EVENT[18]->DESCRIPTION; ?>
	 </div>
    </div>
    ...
    <div class="item" style="overflow:scroll; height:300px; ">
	  ...
	  <?php  echo $EVENTLIST->EVENT[18]->RULES; ?>
	 </div>
    </div>
     <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container"><br>
	 
	 <?php  echo $EVENTLIST->EVENT[18]->TIMELINE; ?>
	 </div>
    </div>
    <div class="item" style="overflow:scroll; height:300px; ">
     <div class="container" ><br>
	 
	<?php  echo $EVENTLIST->EVENT[18]->CONTACTS; ?>
	 </div>
    </div>
  </div>
  ...
  <!-- Controls 
  <a class="left carousel-control" href="#carousel-example-generic18" role="button" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left"></span>
  </a>
  <a class="right carousel-control" href="#carousel-example-generic18" role="button" data-slide="next">
